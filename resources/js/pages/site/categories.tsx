...
import { Search, TrendingUp, Users, FileText, Calendar } from 'lucide-react'
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {trendingCategories.map((category) => (
                <Card key={category.slug} className={`border-2 ${category.color.split(' ')[2]} hover:shadow-lg transition-all duration-200`}>
                  ...
                  <CardContent>
                    <div className="flex items-center justify-between text-sm text-muted-foreground mb-2">
                      ...
                      <span className="text-green-600 font-medium">{category.weeklyGrowth}</span>
                    </div>
                  </CardContent>
                </Card>
              ))}
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {filteredCategories.map((category) => (
              <Card key={category.slug} className="hover:shadow-lg transition-all duration-200">
                <CardHeader>
                ...
                <CardContent>
                  <div className="flex items-center justify-between text-sm text-muted-foreground">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-green-600 font-medium">{category.weeklyGrowth} this week</span>
                    </div>
                  </div>
                  <div className="mt-4">
