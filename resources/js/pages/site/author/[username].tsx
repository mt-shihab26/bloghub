                        ...
                        <CardContent className="pt-6">
                            <div className="flex flex-col items-start space-y-4 md:flex-row md:items-center md:space-y-0 md:space-x-6">
                                ...
                                <div className="flex-1">
                                    <h1 className="mb-2 text-3xl font-bold">{authorData.name}</h1>
                                    <p className="mb-4 text-muted-foreground">@{authorData.username}</p>
                                    <p className="mb-4 text-lg">{authorData.bio}</p>
